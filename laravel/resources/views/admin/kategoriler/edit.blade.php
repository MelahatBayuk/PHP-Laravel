            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="{{route('kategoriler.update',$kategori->id)}}" method="PUT" class="form-horizontal" onsubmit="return ajaxekle();" id="ajax-form">
                        {{csrf_field()}}                    <div class="control-group">
...
<!-- tüm seçtiğimiz kategorinin içerisinde benim düzenlemek istediğim kategorinin ust id si gelen id lerden birtanesine eşit ise selected değeri ver -->
