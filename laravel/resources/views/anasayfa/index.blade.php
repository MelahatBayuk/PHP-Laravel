...
@section('icerik')
                                ...
                                <div class="zm-post-header">
                                    ...
                                    <div class="zm-post-meta">
                                        <ul>
                                            ...
                                            <li class="s-meta">{{trans('meta.goruntuleme')}} : <a href="#" class="zm-date">{!! views($tekli)->count() !!}</a></li>
    ...
    <div class="zm-section bg-white pt-20 ptb-40">
        <div class="container">
            <div class="row">
                    <!-- Start left side -->
                                            ...
                                            <div class="zm-post-header">
                                                ...
                                                <div class="zm-post-meta">
                                                    <ul>
                                                        ...
                                                        <li class="s-meta">Görüntüleme :<a href="#" class="zm-date">{!! views($yeni)->count() !!}</a></li>
