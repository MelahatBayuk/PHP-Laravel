                                ...
                                @if($sonuclar->count()<=0)
                                    <div class="col-md-12">
                                        <article class="zm-post-lay-a">
                                            Aradığınız Kelime İle İlgili Herhangi Bİr İçerik Bulunamadı.
                                        </article></div>
                                @else


                                    @foreach($sonuclar as $yazi)
                                            ...
                                            <article class="zm-post-lay-a">
                                                ...
                                                <div class="zm-post-dis">
                                                    <div class="zm-post-header">
                                                        <div class="zm-category"><a href="/kategori/{{$yazi->kategorisi->id}}/{{$yazi->kategorisi->slug}}" class="bg-cat-5 cat-btn">{{$yazi->kategorisi->baslik}}</a></div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <nav class="zm-pagination ptb-40 text-center">
                                        <ul class="page-numbers">
                                            {{$sonuclar->appends(Request::only('kelime'))->links()}}
